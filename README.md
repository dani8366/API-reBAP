...
Dependencies installieren: pip install pandas requests openpyxl

Konfiguration: API-Credentials in reBap.py hinterlegen (Client-ID & Secret).

Prozess starten: python reBap.py Der ETL-Prozess extrahiert die Daten, transformiert sie und speichert den Report reBAP_Export_YYYY-MM.xlsx lokal ab.
